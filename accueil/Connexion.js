...
const Connexion=()=> {
  ...
  return (
    ...
    console.log({...Infos,mdp:mdp})
        axios.post("http://localhost:3000/accueil/connect",{...Infos,mdp:mdp}).then((res)=>{console.log("coucou2",res.data,mdp);if(res.data.mdp==mdp){console.log("coucou3");navigation.navigate("Structure")}})
